...
#define LIGHTER_COMPILER_MSVC 1
#define LIGHTER_COMPILER_MSVC_VERSION _MSC_VER
#else
#define LIGHTER_COMPILER_MSVC 0
#define LIGHTER_COMPILER_MSVC_VERSION 0
#endif
...
#if LIGHTER_COMPILER_MSVC && (LIGHTER_COMPILER_MSVC_VERSION < 1950) && \
    (defined(_CRT_USE_ADDRESS_SANITIZER) || defined(__SANITIZE_ADDRESS__))
#define LIGHTER_WORKAROUND_MSVC_COROUTINE_ASAN_UAF 1
#else
#define LIGHTER_WORKAROUND_MSVC_COROUTINE_ASAN_UAF 0
#endif
...
#if __has_cpp_attribute(msvc::no_unique_address) && !LIGHTER_WORKAROUND_MSVC_COROUTINE_ASAN_UAF
#define LIGHTER_NO_UNIQUE_ADDRESS [[msvc::no_unique_address]]
#elif __has_cpp_attribute(no_unique_address)
#define LIGHTER_NO_UNIQUE_ADDRESS [[no_unique_address]]
#else
#define LIGHTER_NO_UNIQUE_ADDRESS
#endif
#else
#define LIGHTER_NO_UNIQUE_ADDRESS
#endif
...
#define LIGHTER_WORKAROUND_WINDOWS_ASAN_COROUTINE_EXCEPTION 1
#elif defined(_WIN32) && defined(__has_feature)
#if __has_feature(address_sanitizer)
#define LIGHTER_WORKAROUND_WINDOWS_ASAN_COROUTINE_EXCEPTION 1
#endif
#endif
#ifndef LIGHTER_WORKAROUND_WINDOWS_ASAN_COROUTINE_EXCEPTION
#define LIGHTER_WORKAROUND_WINDOWS_ASAN_COROUTINE_EXCEPTION 0
#endif

#if defined(LIGHTER_ENABLE_EXCEPTIONS)
#if LIGHTER_ENABLE_EXCEPTIONS && !defined(__cpp_exceptions)
#undef LIGHTER_ENABLE_EXCEPTIONS
#define LIGHTER_ENABLE_EXCEPTIONS 0
#endif
#elif defined(__cpp_exceptions)
#define LIGHTER_ENABLE_EXCEPTIONS 1
#else
#define LIGHTER_ENABLE_EXCEPTIONS 0
#endif

#if LIGHTER_ENABLE_EXCEPTIONS
#define LIGHTER_THROW(exception_expr) throw exception_expr
#define LIGHTER_TRY try
