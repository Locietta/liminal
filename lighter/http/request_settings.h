...
struct RequestSettings {
    ...
    RequestSettings &operator=(const RequestSettings &) = default;
    RequestSettings &operator=(RequestSettings &&) noexcept = default;
    ...
    decltype(auto) redirect(this auto &&self, http::RedirectPolicy value) {
    ...
    decltype(auto) min_tls_version(this auto &&self, http::TlsVersion value) {
        self.tls_config.min_version = value;
        return std::forward<decltype(self)>(self);
    }

    decltype(auto) max_tls_version(this auto &&self, http::TlsVersion value) {
...
protected:
    ...
    http::RedirectPolicy redirect_policy_value = http::RedirectPolicy::limited();
    http::TlsOptions tls_config{};
